...
import static org.apache.samza.sql.bench.utils.TestDataGenerator.loadProductsSchema;

public class ProductsEncoder implements Encoder<GenericRecord> {
  private final DatumWriter datumWriter;

  public ProductsEncoder(VerifiableProperties props) throws IOException {
    this.datumWriter = new GenericDatumWriter<GenericRecord>(new Schema.Parser().parse(loadProductsSchema()));
  }
