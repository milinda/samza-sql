...
public class MockSamzaSQLConnection implements SamzaSQLConnection {

  private SchemaPlus root = Frameworks.createRootSchema(false);

  private String schema;

  private final String model;

  public MockSamzaSQLConnection(String model) throws IOException {
    this.model = model;
