 ...
 */
package org.apache.samza.sql.operators.filter;
...
/**
 * This is a built-int operator that performs streaming filtering.
 */
public class FilterOp extends SimpleOperatorImpl {

  /**
   * The specification of this {@code FilterOp}
   */
  private final FilterSpec spec;

  /**
   * Ctor that takes {@link org.apache.samza.sql.operators.filter.FilterSpec} as an input.
   *
   * @param spec The <code>FilterSpec</code> object
   */
  public FilterOp(FilterSpec spec) {
    super(spec);
    this.spec = spec;
  }
