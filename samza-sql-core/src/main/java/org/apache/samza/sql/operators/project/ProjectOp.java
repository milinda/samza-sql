...
/**
 * This is a built-in operator that performs stream projection
 */
public class ProjectOp extends SimpleOperatorImpl {

  /**
   * The specification of this {@code ProjectOp}
   */
  private final ProjectSpec spec;

  /**
   * Ctor that takes {@link org.apache.samza.sql.operators.project.ProjectSpec} object as input.
   *
   * @param spec The <code>ProjectSpec</code> object
   */
